...
public class ReceptionApiService extends BaseApiService {


    public List<ReceptionAnnouncementModel> obtenerAnuncios() throws Exception {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(baseUrl + "/api/v1/reception-announcements"))
                .header("Authorization", "Bearer " + getToken())
                .GET()
                .timeout(Duration.ofSeconds(5))
                .build();
        HttpResponse<String> response = httpClient.send(request, HttpResponse.BodyHandlers.ofString());
        return parseList(response.body(), ReceptionAnnouncementModel.class);
    }

    public List<ReceptionAnnouncementModel> obtenerAnunciosPendientes() throws Exception {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(baseUrl + "/api/v1/reception-announcements/pending"))
                .header("Authorization", "Bearer " + getToken())
                .GET()
                .timeout(Duration.ofSeconds(5))
                .build();
    ...
    public ReceptionAnnouncementModel crearAnuncio(ReceptionAnnouncementModel model) throws Exception {
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .build();
        HttpResponse<String> response = httpClient.send(request, HttpResponse.BodyHandlers.ofString());
        return parseSingle(response.body(), ReceptionAnnouncementModel.class);
    }

    public ReceptionAnnouncementModel actualizarAnuncio(String id, ReceptionAnnouncementModel model) throws Exception {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(baseUrl + "/api/v1/reception-announcements/" + id))
                .header("Authorization", "Bearer " + getToken())
                .header("Content-Type", "application/json")
                .PUT(HttpRequest.BodyPublishers.ofString(gson.toJson(model)))
                .timeout(Duration.ofSeconds(5))
                .build();
        HttpResponse<String> response = httpClient.send(request, HttpResponse.BodyHandlers.ofString());
        return parseSingle(response.body(), ReceptionAnnouncementModel.class);
    ...
    public List<ReceptionModel> obtenerRecepciones() throws Exception {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(baseUrl + "/api/v1/receptions"))
                .header("Authorization", "Bearer " + getToken())
                .GET()
                .timeout(Duration.ofSeconds(5))
                .build();
        HttpResponse<String> response = httpClient.send(request, HttpResponse.BodyHandlers.ofString());
        return parseList(response.body(), ReceptionModel.class);
    }
    ...
    public ReceptionModel crearRecepcion(ReceptionModel model) throws Exception {
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .build();
        HttpResponse<String> response = httpClient.send(request, HttpResponse.BodyHandlers.ofString());
        return parseSingle(response.body(), ReceptionModel.class);
}
